...
import NoteHome from '../Projects/Notes/NoteHome';
...
const Contact = () => {
        ...
        function sendEmail(e) {
            ...
            emailjs.sendForm('service_mswtaov', 'template_ntx86yo', e.target, 'JD4KonpCb7XGna6tR')
                .then((result) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div className="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                            ...
                            <div className="ml-4 text-md tracking-wide font-semibold w-40">Dhaka, Bangladesh, 1000</div>
                        </div>
                        ...
                        <div className="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                            ...
                            <div className="ml-4 text-md tracking-wide font-semibold w-40">hexa@tech.com</div>
                        </div>
                    </div>
                    <form onSubmit={sendEmail} className="p-6 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col mt-2">
                            ...
                            <input type="email" name="user_email" id="email" placeholder="Email" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
                        </div>

                        <div className="flex flex-col mt-2">
                            <label for="tel" className="hidden">Message</label>
                            <textarea type="tel" name="message" id="tel" placeholder="Write Your Message" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" ></textarea>
                        </div>
