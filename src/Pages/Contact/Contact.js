                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div class="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                            ...
                            <div class="ml-4 text-md tracking-wide font-semibold w-40">Dhaka, Bangladesh, 1000</div>
                        </div>
                        ...
                        <div class="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                            ...
                            <div class="ml-4 text-md tracking-wide font-semibold w-40">hexa@tech.com</div>
                        </div>
                    </div>
                    <form class="p-6 flex flex-col justify-center">
                        ...
                        <div class="flex flex-col mt-2">
                            ...
                            <textarea type="tel" name="tel" id="tel" placeholder="Write Your Message" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" ></textarea>
                        </div>
