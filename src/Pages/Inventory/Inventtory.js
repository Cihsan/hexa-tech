        ...
        <div className='hero min-h-screen'>
            <div className="lg:card-side grid grid-cols-1 lg:grid-cols-2 items-center justify-items-center lg:mx-12">
                <div className="card-body my-6">
                    <h2 className="card-title text-4xl leading-tight">Get Store &<br />Order Management
                    </h2>
                ...
                <figure className='flex items-center'><img style={{width:"800px"}} className='' src="https://i.ibb.co/gMDTBzS/download.png" alt="Album" /></figure>
            </div>
        </div>
    );
};
