...
const Messaging = () => {
  ...
  <div className="flex flex-col justify-between items-center flex-none w-16 bg-gray-200">
    <div className="flex flex-col space-y-4 w-full items-center pt-5">
      ...
      <a className="block relative w-full h-16 w-16 flex justify-center items-center">
  ...
  <div className="w-64 flex-none bg-gray-100 p-4 flex flex-col space-y-4">
    ...
    <div className="bg-blue-200 h-64"></div>
    <div className="bg-blue-200 h-64"></div>
  </div>
...
<div className='p-4'></div>
  ...
  <div className="flex flex-row flex-auto bg-white rounded-tl-xl border-l shadow-xl p-4">
    <div className="flex flex-col w-1/5 m-4">
      <div className="flex justify-center items-center rounded font-bold text-2xl h-24 bg-blue-200">  Recent Chats</div>
...
//                         <a>
//                             <div className='rounded-full bg-base-100 w-8 h-8'></div>
//                         </a>
//                         <a>
//                             <div className='rounded-full bg-base-100 w-8 h-8'></div>
//                         </a>
...
//                                         <div class="flex-grow truncate text-xs">some message content </div>
//                                     </div>
//                                 </div>
//                             </a>
