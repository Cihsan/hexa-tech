        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://hexatech-server.herokuapp.com/review-post', {
                        method: 'POST',
                        headers: {
                    ...
                    <div className=" px-6">
                        ...
                        <div className="">
                            ...
                            <div className="w-full bg-white p-5 rounded-lg lg:rounded-l-none">
                                <h3 className="text-2xl text-center">Write Your Review Here</h3>
                                <form onSubmit={handleSubmit(onSubmit)} className="px-8 pb-8 mb-4 bg-white rounded">
                                    <div className="mb-4">
                                        <label className="mb-2 w-6/12 text-sm font-bold text-gray-700">
                                            Name
                                        </label>
                                        <input
                                            {...register("name", {
                                    ...
                                    <div className="mb-6 text-center">
                                        <input
                                            className="w-full px-4 cursor-pointer py-2 font-bold text-white bg-primary rounded hover:bg-accent focus:outline-none focus:shadow-outline"
                                            type="submit"
                                            value='Submit Review'
                                        />
                                    </div>
